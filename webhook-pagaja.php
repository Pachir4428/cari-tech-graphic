 ...
 *
 * Responde sempre 2xx rapidamente (exigência da PagaJá — 10s), mesmo quando o
 * evento não corresponde a nenhuma cobrança pendente conhecida (ex.: um teste
 * a partir do painel da PagaJá), para nunca ser marcado como "falhado" lá.
 */
